//
//  ParticleAxisAlignedRectangleCollision.m
//  GameCore
//
...
+ (Vector2*) calculateRelaxDistanceBetween:(id<IParticleCollider>)particle and:(id<IAxisAlignedRectangleCollider>)axisAlignedRectangle;
